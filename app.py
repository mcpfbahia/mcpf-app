...
# Opção de upload
uploaded_file = st.file_uploader("📤 Faça o upload da planilha de preços (opcional):", type="xlsx")

# Se não fizer upload, usa a planilha base
if uploaded_file is not None:
    df = load_data(uploaded_file)
    st.success("✅ Planilha carregada com sucesso!")
else:
    df = load_data('mcpf_formacao_preco_base.xlsx')
    st.info("ℹ️ Usando planilha base padrão.")
